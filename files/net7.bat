...
reg add "hklm\system\controlset001\control\class\%guid2%\0007" /v "*speedduplex" /t reg_sz /d "0" /f
...
reg add "hklm\system\controlset001\control\class\%guid2%\0007" /v "loglinkstateevent" /t reg_sz /d "16" /f
...
reg add "hklm\system\controlset001\control\class\%guid2%\0007" /v "masterslave" /t reg_sz /d "0" /f
